        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yinshijianyi" label="饮食建议" prop="yinshijianyi">
                    <span>{{ruleForm.yinshijianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.yundongjianyi" label="运动建议" prop="yundongjianyi">
                    <span>{{ruleForm.yundongjianyi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
