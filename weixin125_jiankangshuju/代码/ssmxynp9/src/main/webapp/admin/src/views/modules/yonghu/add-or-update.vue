<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="账号状态" prop="zhuangtai">
          <el-select v-model="ruleForm.zhuangtai" placeholder="请选择账号状态">
            <el-option label="正常" value="正常"></el-option>
            <el-option label="禁用" value="禁用"></el-option>
          </el-select>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="账号状态" prop="zhuangtai">
            <el-input v-model="ruleForm.zhuangtai" placeholder="账号状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
